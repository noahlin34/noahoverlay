...
DESCRIPTION="An asynchronously sinking fork of dwmblocks."
...
# Portage.
EGIT_REPO_URI="https://github.com/UtkarshVerma/dwmblocks-async.git"
...
src_prepare() {
	...
	restore_config config.c config.h
